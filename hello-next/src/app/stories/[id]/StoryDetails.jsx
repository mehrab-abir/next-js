...
const StoryDetails = async ({id}) => {
    const stories = [
      {
        ...
        image: "https://i.ibb.co/C3Kwgfc9/loki.webp",
      },
      {
        id: 2,
        name: "Sara Ahmed",
        ...
        image: "https://i.ibb.co/9PRw260/Raisa.png",
      },
      {
        id: 3,
        name: "Rahul Das",
        ...
        image: "https://i.ibb.co/M5MFcxKc/thor.jpg",
      },
      {
        id: 4,
        name: "Zahidul Karim",
        ...
        image: "https://i.ibb.co/k2vb44cf/jon-snow.webp",
      },
      {
        id: 5,
        name: "Maya Siddiqui",
        ...
        image: "https://i.ibb.co/whrmNDj2/arya-stark.jpg",
      },
    ];
    ...
    if(!story){
        return <h2 className='text-red-500 text-xl'>Story not found</h2>
    }

    return (
        <div className="max-w-3xl mx-auto bg-gray-900 shadow-md rounded-lg p-6 border border-gray-200">
      {/* Top Section */}
